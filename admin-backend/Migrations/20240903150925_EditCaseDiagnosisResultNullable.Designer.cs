...
namespace CommonLibrary.Migrations
{
    ...
    [Migration("20240903150925_EditCaseDiagnosisResultNullable")]
    partial class EditCaseDiagnosisResultNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("admin_backend.Entities.CaseHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("admin_backend.Entities.CaseHistory", b =>
                {
                    b.HasOne("admin_backend.Entities.CaseRecord", "CaseRecord")
                        .WithMany()
                        .HasForeignKey("CaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
